      *> ============================================================
      *> TEST-A.cbl - Alphabet to Numeric MOVE (Matrix 1.3 A1, 16 scenes)
      *>
      *> Output: SCENE|ROLE|FIELD|BEFORE_HEX|AFTER_HEX|BEFORE_DISP|AFTER_DISP|STATUS|NOTE
      *>
      *> Design: Uses helper paragraphs to reduce repetition.
      *> Each scene calls R-SRC-B/A and R-TGT-B/A to record source and target variables.
      *> ============================================================
      ...
      *> ==========================================================
      *> Helper paragraphs: R-HEX / T-B / T-A
      *> R-HEX: Convert WS-DUMP-SRC(WS-LEN) to HEX
      *> T-B: Record target BEFORE
      *> T-A: Record target AFTER and output
      *> ==========================================================
       R-HEX.
