...
NacaRT uses mail to immediatly report runtime problems. This section configures it in tag of tag , itself within tag .
The tag can contain a collection of tags that each give a destination email address. There can be multiple tags, so that a nacaRT generated mail is sent to multiple destinations.
