...
public abstract class BaseProgramManager extends CJMapObject
{
    ...
    public BaseProgram prepareCall(
        ...
        ArrayList arrCallerCallParam,
        BaseEnvironment env,
        boolean bNewProgramInstance)
    {
                            ...
                            if(type != null)
                            {
                                ...
                                if(superType != null)
                                {
                                    ...
                                    if(csSuperTypeName != null)
                                    {
                                        ...
                                        {
                                            Log.logImportant("setVarName: Unhandled nacaLib type=" + csSuperTypeName + " SuperType="
                                                + csTypeName);
                                        }
                                    }
                                }
...
//  }
    ...
    {
        this.sortParagHandler = sortParagHandler;
    }
