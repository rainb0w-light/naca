...
//      unlock
    ...
    public void asyncAddItemToSortByMultiThreads(MultiThreadedSortAddItem multiThreadedSortItem, byte tbyData[])
    {
        ...
        byte tbyKey[] = keyDescription.fillNewKeyBuffer(
            tbyData,
            multiThreadedSortItem.nNbRecordRead,
            multiThreadedSortItem.isvariableLength);
    ...
    public boolean externalSortInsertWithRecordIndexAtEnd(
        ...
        LineRead lineRead,
        int nNbRecordRead,
        boolean bFileInEbcdic,
        boolean bFileInVariableLength)
    {
