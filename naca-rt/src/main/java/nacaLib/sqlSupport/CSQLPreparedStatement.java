            ...
            catch(IllegalArgumentException e)
            {
                ...
                if(cs.length() == 8)    // Time hh.mm.ss
                {
                    ...
                    catch (SQLException e1)
                    {
                        ...
                        sql.sqlStatus.setSQLCode("setVarParamValue with autodefined time " +
                            "column", e1, csQueryString/*, csSourceFileLine*/, sql);
                    }
                }
                else if(cs.length() == 10)  // Date dd.mm.yyyy
                {
                    ...
                    {
                        LogSQLException.log(e1);
                        sql.sqlStatus.setSQLCode("setVarParamValue with autodefined date " +
                            "column", e1, csQueryString/*, csSourceFileLine*/, sql);
                    }
                }
                else
                {
                    ...
                    sql.sqlStatus.setSQLCode("setVarParamValue with autodefined date/time " +
                        "column", -1, e.toString(), csQueryString/*, csSourceFileLine*/);
                }
            }
