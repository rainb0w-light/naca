...
public class VarDefEditInMapRedefineNum extends VarDefEditInMapRedefineBase
{
    ...
    /** Creates a new var def edit in map redefine num instance. */
...
// bufferDest.copyBytesFromSource(getBodyAbsolutePosition(bufferDest), bufferSource, varSource.getBodyAbsolutePosition(bufferSource),
// nNbCharToCopy);
//  }
