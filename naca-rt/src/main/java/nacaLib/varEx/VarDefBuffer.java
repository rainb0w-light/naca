...
public abstract class VarDefBuffer extends VarDefBase
{
    ...
    protected int internalWriteRightPaddingBlankInitSpace(
        VarBufferPos buffer,
        int nPosition,
        int nTotalSize,
...
//  }
    ...
    protected void internalPhysicalWrite(VarBufferPos bufferDest, VarDefBuffer varSource, VarBufferPos bufferSource)
    {
        ...
        bufferDest.copyBytesFromSource(
            getBodyAbsolutePosition(bufferDest),
            bufferSource,
            varSource.getBodyAbsolutePosition(bufferSource),
            nNbCharToCopy);
    }
...
//  }
    ...
    void moveCorrespondingItemAndChildren(
        MoveCorrespondingEntryManager manager,
        SharedProgramInstanceData sharedProgramInstanceData,
        BaseProgramManager programManager,
        VarDefBase varDefDestGroup,
        int nSourceOffset,
        int nDestOffset)
    {
        if(arrChildren == null) // Final node
...
//  }
    ...
    void initializeItemAndChildren(
        VarBufferPos varBufferPos,
    ...
    private void initializeItemAndChildren(
        TempCache cache,
        VarBufferPos varBufferPos,
        InitializeManager initializeManager,
        int nOffset,
...
//  }
    ...
    public void writeToFile(
        ...
        VarBufferPos bufferPos,
        boolean bConvertUnicodeToEbcdic)
    {
        if(arrChildren == null) // Final node
        {
