        ...
        if(occursItemSettings != null && occursItemSettings.arrVarDefOccursOwner != null)
        {
            ...
            for(int n=0; n<nNbDimensions; n++)
            {
                ...
                int nDistanceFromOccursOwner
                        = varDefOccursOwnerCurrent.nDefaultAbsolutePosition - varDefOccursOwner.nDefaultAbsolutePosition;
                int nSignleEntrySize = varDefOccursOwner.getOneEntrySize();
                occursItemSettings.aOccursOwnerLocation[n] = new OccursOwnerLocation(
                    nDistanceFromOccursOwner,
                    varDefOccursOwner.nDefaultAbsolutePosition,
                    nSignleEntrySize);
    ...
    private void calcAbsolutePosition(SharedProgramInstanceData sharedProgramInstanceData)
    {
        ...
        else // We are not a redefine
        {
            ...
            if (varDefPreviousSameLevelNonRedefine != null) {
                nDefaultAbsolutePosition = varDefPreviousSameLevelNonRedefine.nDefaultAbsolutePosition
...
//  }
    ...
    abstract void initializeItemAndChildren(
