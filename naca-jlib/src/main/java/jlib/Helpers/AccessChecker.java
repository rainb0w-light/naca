 ...
 */
    public void grantWriteAccessToUsersOrGroups(String functionPath,String usersOrGroups) throws Exception {
        try {
            ...
            throw new Exception(ParseError.parseError(
                "AccessChecker.grantWriteAccessToUsersOrGroups('"+functionPath+"','"+usersOrGroups+"')",
                e));
        }
    }
 ...
 * @exception Exception if <code>usersOrGroups</code> contains undeclared users or groups.
 */
    public void grantWriteAccessToUsersOrGroups(
        String functionPath,
        ...
        try {
            ...
            throw new Exception(ParseError.parseError("AccessChecker.grantWriteAccessToUsersOrGroups('" + functionPath + "','"
                + usersOrGroups + "','" + parameterName + "','" + parameterValue + "')",e));
        }
    }
 ...
 */
    public void grantReadAccessToUsersOrGroups(String functionPath,String usersOrGroups) throws Exception {
        try {
            ...
            throw new Exception(ParseError.parseError(
                "AccessChecker.grantReadAccessToUsersOrGroups('"+functionPath+"','"+usersOrGroups+"')",
                e));
        }
    }
 ...
 * @exception Exception if <code>usersOrGroups</code> contains undeclared users or groups.
 */
    public void grantReadAccessToUsersOrGroups(
        String functionPath,
        String usersOrGroups,
        String parameterName,
        String parameterValue) throws Exception {
        try {
            ...
            throw new Exception(ParseError.parseError("AccessChecker.grantReadAccessToUsersOrGroups('" + functionPath + "','"
                + usersOrGroups + "','" + parameterName + "','" + parameterValue + "')",e));
        }
    }
 ...
 */
    public void denyWriteAccessToUsersOrGroups(String functionPath,String usersOrGroups) throws Exception {
        try {
            ...
            throw new Exception(ParseError.parseError(
                "AccessChecker.denyWriteAccessToUsersOrGroups('"+functionPath+"','"+usersOrGroups+"')",
                e));
        }
    }
 ...
 * @exception Exception if <code>usersOrGroups</code> contains undeclared users or groups.
 */
    public void denyWriteAccessToUsersOrGroups(
        String functionPath,
        String usersOrGroups,
        String parameterName,
        String parameterValue) throws Exception {
        try {
            ...
            throw new Exception(ParseError.parseError("AccessChecker.denyWriteAccessToUsersOrGroups('" + functionPath + "','"
                + usersOrGroups + "','" + parameterName + "','" + parameterValue + "')",e));
        }
    }
 ...
 */
    public void denyReadAccessToUsersOrGroups(String functionPath,String usersOrGroups) throws Exception {
        try {
            ...
            throw new Exception(ParseError.parseError(
                "AccessChecker.denyReadAccessToUsersOrGroups('"+functionPath+"','"+usersOrGroups+"')",
                e));
        }
    }
 ...
 * @exception Exception if <code>usersOrGroups</code> contains undeclared users or groups.
 */
    public void denyReadAccessToUsersOrGroups(
        String functionPath,
        String usersOrGroups,
        String parameterName,
        String parameterValue) throws Exception {
        try {
            ...
            throw new Exception(ParseError.parseError("AccessChecker.denyReadAccessToUsersOrGroups('" + functionPath + "','" + usersOrGroups
 ...
 * @exception Exception if <code>usersOrGroups</code> contains undeclared users or groups.
 */
    public void establishAccessToUsersOrGroups(
        String action,
        String access,
        String functionPath,
        String usersOrGroups,
...
//****************************** Exception management ******************************************
            ...
            throw new Exception(ParseError.parseError("AccessChecker.establishUserOrGroupAccess('" + action + "','" + functionPath + "','"
                + usersOrGroups + "','" + parameterName + "','" + parameterValue + "')",e));
        }
    }
 ...
 */
    public boolean hasUserAccessTo(String userName,String accessType,String functionPath) throws Exception {
        try {
            ...
            throw new Exception(ParseError.parseError(
                "AccessChecker.hasUserAccessTo('"+userName+"','"+accessType+"','"+functionPath+"')",
                e));
        }
    }
 ...
 *     not empty.
 */
    public boolean hasUserAccessTo(
        String userName,
        String accessType,
        String functionPath,
        String parameterName,
...
//************************************** Exception manager ********************************
            ...
            throw new Exception(ParseError.parseError(
                "AccessChecker.hasUserAccessTo('"+userName+"','"+functionPath+"','"+parameterName+"','"+parameterValue+"')",
                e));
        }
    }
 ...
 */
        ...
        private String toString(int level) {
            ...
            while(valuesIterator.hasNext()) {
                ...
                ss.append(indent + "<parameter name=\"" + parameterName + "\" " + valueEntry.getValue().toString() + ">"
                    + valueEntry.getKey() + "</parameter>\r\n");
            }
            return ss.toString();
        }
    }
