...
public class DbPreparedStatement
{
    ...
    public void setColParam(int nCol, long lValue)
    {
        ...
        catch (SQLException e)
        {
            throw new RuntimeException(
                "Could not set columnn "+String.valueOf(nCol)+" to value '"+String.valueOf(lValue)+"': "+e.getMessage(),
                e);
        }
    }
    ...
    public void setColParam(int nCol, short sValue)
    {
        ...
        {
            throw new RuntimeException(
                "Could not set columnn "+String.valueOf(nCol)+" to value '"+String.valueOf(sValue)+"': "+e.getMessage(),
                e);
        }
    }
    ...
    public void setColParam(int nCol, int nValue)
    {
        ...
        {
            throw new RuntimeException(
                "Could not set columnn "+String.valueOf(nCol)+" to value '"+String.valueOf(nValue)+"': "+e.getMessage(),
                e);
        }
    }
    ...
    public void setColParam(int nCol, java.util.Date dateValue)
    {
        ...
        {
            throw new RuntimeException(
                "Could not set columnn "+String.valueOf(nCol)+" to value '"+dateValue.toString()+"': "+e.getMessage(),
                e);
        }
    }
    ...
    public void setColParamObject(int nCol, Object oValue)
    {
        ...
        {
            throw new RuntimeException(
                "Could not set columnn "+String.valueOf(nCol)+" to value '"+oValue.toString()+"': "+e.getMessage(),
                e);
        }
    }
