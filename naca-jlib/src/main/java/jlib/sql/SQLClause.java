        ...
        if(resultSet != null)
        {
            ...
            catch (SQLException e)
            {
                ...
                ProgrammingException.throwException(
                    ProgrammingException.DB_ERROR_RESULT_SET_COL_BIG_DECIMAL_ACCESS_STRING+csColName,
                    csQuery,
                    e);
            }
        }
        ...
        throws TechnicalException
    {
        if(resultSet != null)
        {
            ...
            catch (SQLException e)
            {
                forceCloseOnExceptionCatched();
                ProgrammingException.throwException(
                    ProgrammingException.DB_ERROR_RESULT_SET_COL_BIG_DECIMAL_ACCESS_INT+nColNumber,
                    csQuery,
                    e);
            }
        }
    ...
    public VarBinary getVarBinary(int nColNumber) throws TechnicalException
    {
        if(resultSet != null)
        {
            ...
            catch (SQLException e)
            {
                forceCloseOnExceptionCatched();
                ProgrammingException.throwException(
                    ProgrammingException.DB_ERROR_RESULT_SET_COL_BIG_DECIMAL_ACCESS_STRING+nColNumber,
                    csQuery,
                    e);
            }
        }
