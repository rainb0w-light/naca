...
{
    private static Hashtable<DbAccessor, DbConnectionManagerContext> ms_dbConnectionManagerContext
        ...
        throws TechnicalException
    {
        ...
        TechnicalException.throwException(
            TechnicalException.MISSING_CONFIGURATION,
            "Could not create DB Connection; maybe missing param in property file for Db Id="+dbId.getKey());
        return null;
    }
