...
public class CurrentDateInfo
{
    ...
    public String getDisplayableDateTime()
    {
        String cs = "" + StringUtil.FormatWithFill2LeftZero(getDay()) + "/" + StringUtil.FormatWithFill2LeftZero(getMonthBase1()) + "/"
            + StringUtil.FormatWithFill4LeftZero(getYear()) + "  " + StringUtil.FormatWithFill2LeftZero(getHour()) + ":"
            + StringUtil.FormatWithFill2LeftZero(getMinute()) + ":" + StringUtil.FormatWithFill2LeftZero(getSecond());
        return cs;
    }
