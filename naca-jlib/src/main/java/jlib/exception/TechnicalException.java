...
//  }
    ...
    public static final String STORED_PROC_CALL_INOUT_PARAM_WAY_NOT_MATCHING_DEF = "A parameter in / inout / out definition does not " +
        "match it's usage during stored procedure call parameters settings: ";
    ...
    public static final String STORED_PROC_CALL_RETRIEVE_OUT_VALUES_ERROR = "Error when retrieve out value from called stored " +
        "procededure; parameter number (1 based): ";
    ...
    public static final String SQL_PARSING_ERROR = "Could not correctly parse SQL Statement to add tablespace prefix; Please check " +
        "statement: ";
