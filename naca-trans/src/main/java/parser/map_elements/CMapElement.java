...
//          }
                ...
                if (le.GetType()==EBMSElementType.FIELD)
                {
                    ...
                    if (field.nLength>0)
                    {
                        ...
                        if (isstore)
                        {
                            ...
                            resStrings.SetResourceText(
                                field.nPosLine,
                                field.nPosCol,
                                field.csInitialValue,
                                getName(),
                                resId,
                                field.nLength) ;
                        ...
                        {
                            // MAP name is used as langid
                            resStrings.SetResourceText(field.nPosLine, field.nPosCol, field.csInitialValue, getName(), field.nLength) ;
                        }
                    }
                }
    ...
    private void ManageArray()
    {
        ...
        SortedSet<CFieldElement> fields =  new TreeSet<CFieldElement>(comp) ;
