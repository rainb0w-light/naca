...
public class CGlobalEntityCounter
{
	...
	{
		public String m_ItemName = "" ;
		public HashMap<String, Integer> m_tabCount = new HashMap<String, Integer>() ;
		public ArrayList<String> m_arrDeps = new ArrayList<String>();
	}
...
//					eOpt.setAttribute("Count", ""+n);
		...
		if (m_arrProgramToRewrite.size()>0)
		{
			...
			{
				Element e = root.createElement("Program");
				e.setAttribute("Name", m_arrProgramToRewrite.get(i));
				e.setAttribute("Line", ""+m_arrProgramLinesToRewrite.get(i));
				e.setAttribute("Reason", m_arrProgramToRewriteReason.get(i));
				eRew.appendChild(e);
			}
		}
		return eItemCount ;
	...
	{
		m_arrProgramLinesToRewrite.add(line);
		m_arrProgramToRewrite.add(progName);
		m_arrProgramToRewriteReason.add(reason);
	}
	protected ArrayList<String> m_arrProgramToRewrite = new ArrayList<String>();
	protected ArrayList<String> m_arrProgramToRewriteReason = new ArrayList<String>();
	protected ArrayList<Integer> m_arrProgramLinesToRewrite = new ArrayList<Integer>() ;
}
